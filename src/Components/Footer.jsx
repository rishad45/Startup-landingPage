                ...
                <div className="container">
                    <div className="row">
                        <div className="col-lg-12">
                            <div
                                className="footer-logo-support d-md-flex align-items-end justify-content-between"
                            >
                    ...
                    <div className="row">
                        <div className="col-lg-12">
                            <div className="copyright text-center">
                                <p className="text">
                                    Template Crafted by
                                    <a rel="nofollow" href="../../index.htm">UIdeck</a> - UI
                                    Powered by
                                    <a el="nofollow" href="../../index-1.htm">AyroUI</a>
                                </p>
                            </div>
                        </div>
                    </div>
